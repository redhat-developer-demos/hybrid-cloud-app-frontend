...
public class Data {
  ...
  public void updateWorker(String workerId, String cloudId) {
    this.workers.putIfAbsent(workerId,
        new WorkerUpdate(workerId, cloudId, System.currentTimeMillis(), 0));
  ...
  public String toString() {
    return String.format("Data{requestIds=%s, responses=%s, workers=%s}", requestIds, responses,
        workers);
  }
